...
public class Product {
	...
	@OneToMany(targetEntity = CartProduct.class, mappedBy = "product",cascade = CascadeType.ALL,fetch = FetchType.EAGER)
	private List<CartProduct> cartProduct;
	
	public Product() {
		super();
	}
	public Product(String productName, Double price, User seller, Category category, List<CartProduct> cartProduct) {
		super();
